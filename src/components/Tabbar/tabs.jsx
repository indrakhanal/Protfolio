...
import { Backend, Frontend, Development, Languages, Tools, GenAIHealthcare } from "./Tech/skills";
          ...
          <TabContext style={{ overflow: "scroll" }} value={value}>
            <Box sx={{ borderBottom: 2, borderColor: 'divider' }}>
              <TabList onChange={handleChange} aria-label="lab API tabs example">
                ...
                <Tab style={{ color: darkMode ? "white" : "" }} label="AI & Healthcare" value="5" />
                <Tab style={{ color: darkMode ? "white" : "" }} label="Tools" value="6" />
